...
int main()
{
    ...
    Counter::incrementCount(); // Increment count (count = 1)
    cout << "Counter::incrementCount: " << obj1.getCount() << endl;  // Output: 1

    obj1.incrementCount();  // Increment count (count = 2)
    cout << "obj1: " << obj1.getCount() << endl;  // Output: 2

    obj2.incrementCount();  // Increment count (count = 3)
    cout << "obj2: " << obj2.getCount() << endl;  // Output: 3

    obj3.decrementCount();  // Decrement count (count = 2)
    cout << "obj3: " << obj3.getCount() << endl;  // Output: 2
